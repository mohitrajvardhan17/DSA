...
public class SelectionSortStableTest {

    @Test
    public void sortString() {
        Comparator<Character> comparator = Character::compare;
        SortingStrategy<Character> insertionSort = new SelectionSortStable<>(comparator);
    ...
    public void sortInteger() {
        ...
        SortingStrategy<Integer> insertionSort = new SelectionSortStable<>(comparator);
